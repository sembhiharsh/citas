              ...
              <div className="lg:col-span-8 space-y-8">
                <form id="appointment-form" onSubmit={handleFormSubmit} className="space-y-8">
                  ...
                  <div className="bg-[#131B2A] border border-slate-800 rounded-2xl p-6 space-y-4">
                    ...
                    {selectedService === 'mecanica-general' && (
                      <div className="pt-2">
                        <label className="text-xs text-slate-400 block mb-1">Describe brevemente la anomalía o trabajo requerido:</label>
                        <input
                          type="text"
                          placeholder="Ej. Ruido en la rueda delantera izquierda al girar"
                          value={customServiceText}
                          onChange={(e) => setCustomServiceText(e.target.value)}
                          className="w-full bg-[#0B0F17] border border-slate-700 rounded-lg px-3 py-2 text-xs text-slate-200 focus:border-blue-500 outline-none"
                        />
                      </div>
                    )}
                  </div>
